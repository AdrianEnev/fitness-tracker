        ...
        <View style={tw`flex flex-col ${iphoneModel.includes('Pro') ? "mt-[10%]" : "mt-[15%]"} h-full`}>
            ...
            <View style={tw`flex-1 flex-col gap-y-2 mx-5 mt-[5%]`}>
                ...
                >
                    ...
                    <Text style={tw`text-2xl font-medium ${activityLevel === 1 ? 'text-white' : 'text-gray-500'} mt-1 max-w-[85%]`}>{t('exercise-activity-one')}</Text>
                </Pressable>
                ...
                >
                    ...
                    <Text style={tw`text-2xl font-medium ${activityLevel === 2 ? 'text-white' : 'text-gray-500'} mt-1 max-w-[85%]`}>{t('exercise-activity-two')}</Text>
                </Pressable>
                ...
                >
                    ...
                    <Text style={tw`text-2xl font-medium ${activityLevel === 3 ? 'text-white' : 'text-gray-500'} mt-1 max-w-[85%]`}>{t('exercise-activity-three')}</Text>
                </Pressable>
                ...
                >
                    ...
                    <Text style={tw`text-2xl font-medium ${activityLevel === 4 ? 'text-white' : 'text-gray-500'} mt-1 max-w-[85%]`}>{t('exercise-activity-four')}</Text>
                </Pressable>
                ...
                >
                    ...
                    <Text style={tw`text-2xl font-medium ${activityLevel === 5 ? 'text-white' : 'text-gray-500'} mt-1 max-w-[80%]`}>{t('exercise-activity-five')}</Text>
                </Pressable>
                ...
                >
                    ...
                    <Text style={tw`text-2xl font-medium ${activityLevel === 6 ? 'text-white' : 'text-gray-500'} mt-1 max-w-[80%]`}>{t('exercise-activity-six')}</Text>
                </Pressable>
