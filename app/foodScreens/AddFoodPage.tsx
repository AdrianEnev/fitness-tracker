        ...
        <View style={tw`h-full w-full bg-white`}>
            ...
            <Pressable style={tw`w-full h-[76%] my-2 bg-white`} onPress={() => Keyboard.dismiss()}>
                ...
                <View style={tw`flex flex-row justify-between mt-1 mx-2 w-[95.5%] my-1`}>
                    ...
                    <View style={tw`flex flex-row items-center gapx-2 bg-white rounded-xl shadow-md border border-gray-200`}>
                    ...
                    <TextInput
                        style={tw`w-[22.5%] h-13 bg-white shadow-md rounded-xl border border-gray-200 font-medium text-lg pb-2 text-center`}
