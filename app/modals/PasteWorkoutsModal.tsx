            ...
            >
                <View style={tw`flex-1 justify-center items-center mx-3`}>
                    <Pressable style={tw`bg-white w-full h-[33%] rounded-2xl pt-3 px-2`} onPress={Keyboard.dismiss}>
                        ...
                        <Text style={tw`text-lg text-center font-medium mt-1`}>Paste workout/s</Text>
                        <Text style={tw`text-lg text-center text-gray-500 font-medium mb-1`}>Please choose an option!</Text>
                        ...
                        <View style={tw`w-full h-[50%] flex justify-center flex-row gap-x-3 mt-1`}>
                            ...
                            >
                                ...
                                <Text style={tw`text-white font-medium text-lg`}>Paste cut</Text>
                                <Text style={tw`text-white font-medium text-lg mt-[-5px]`}>workouts</Text>
                            </Pressable>
                            ...
                            >
                                ...
                                <Text style={tw`text-white font-medium text-lg`}>Paste copied</Text>
                                <Text style={tw`text-white font-medium text-lg mt-[-5px]`}>Workouts</Text>
                            </Pressable>
                        </View>
                        ...
                        <View style={tw`flex items-center mt-4`}>
                            <Pressable style={tw`bg-gray-200 w-full h-10 rounded-xl flex items-center justify-center`} onPress={() => setIsPasteWorkoutsModalVisible(false)}>
                                <Text style={tw`text-black text-lg font-medium`}>Go Back</Text>
                            </Pressable>
                        </View>
