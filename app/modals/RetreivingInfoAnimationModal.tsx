        ...
        <Modal
            ...
            >
                <View style={tw`flex-1 justify-center items-center mx-3`}>
                    <Pressable style={tw`bg-white w-[96%] ${iphoneModel.includes('SE') ? "h-[42%]" : "h-[36%]"} rounded-[30px] pt-3 px-2`} onPress={Keyboard.dismiss}>
                        ...
                        <View style={tw`flex-1 justify-end items-center mb-5`}>
                            ...
                            <Text style={tw`text-xl font-medium text-[#3d5875] mt-1 ${iphoneModel.includes('SE') ? "hidden" : ""}`}>{t('few-seconds-alert')}</Text>
                        </View>
