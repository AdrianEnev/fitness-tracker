...
import addWorkout from '@use/workouts/add/useAddWorkout';
import addWorkoutLocally from '@use/workouts/add/useAddWorkoutLocally';
import { useTranslation } from 'react-i18next';
import GlobalContext from '@config/GlobalContext';
import generateID from '@use/settings/add/useGenerateID';
//import { checkWorkoutsCountFolder } from '@use/workouts/useCheckWorkoutsCount';
        ...
        <Modal
            ...
            >
                <View style={tw`flex-1 justify-center items-center mx-3`}>
                    <Pressable style={tw`bg-gray-50 w-full ${iphoneModel.includes('Pro') || iphoneModel.includes('Plus') ? "h-[33%]" : iphoneModel.includes('SE') ? 'h-[45%]' : 'h-[35%]'} rounded-2xl pt-3 px-2`} onPress={Keyboard.dismiss}>
