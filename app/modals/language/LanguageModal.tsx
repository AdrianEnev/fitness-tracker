...
import changeLanguageDB from '@use/settings/change/useChangeLanguage';
    ...
    const saveChanges = async () => {
        ...
        if (selectedLanguage) {
            ...
            if (internetConnected) {
                // Changes language inside database by making request to backend
                changeLanguageDB(selectedLanguage);
            }
