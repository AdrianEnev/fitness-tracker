...
const PageTwo = ({primaryGoal, setPrimaryGoal}: any) => {
    return (
        <View style={tw`flex flex-col mt-[10%] h-full`}>
            ...
            <View style={tw`mx-5`}>
                <Text style={tw`font-medium text-2xl text-center`}>What’s your main fitness goal?</Text>
            ...
            <View style={tw`flex-1 flex-col gap-y-3 mx-5 mt-[5%]`}>
                ...
                >
                    ...
                    <Text style={tw`text-2xl font-medium ${primaryGoal === 1 ? 'text-white' : 'text-gray-500'} mt-1 max-w-[85%]`}>Muscle Gain</Text>
                </Pressable>
                ...
                >
                    ...
                    <Text style={tw`text-2xl font-medium ${primaryGoal === 2 ? 'text-white' : 'text-gray-500'} mt-1 max-w-[85%]`}>Fat Loss</Text>
                </Pressable>
