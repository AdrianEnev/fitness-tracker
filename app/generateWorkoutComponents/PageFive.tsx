    ...
    return (
        <View style={tw`flex flex-col mt-[10%] h-full`}>
            ...
            <View style={tw`flex-1 flex-col gap-y-2 mx-5 mt-[5%]`}>
                ...
                >
                    <Ionicons name='barbell-outline' size={42} color={specificBodyparts.includes(1) ? 'white' : '#6b7280'} style={tw`mt-[6px]`} />
                ...
                >
                    <Ionicons name='flame-outline' size={42} color={specificBodyparts.includes(2) ? 'white' : '#6b7280'} style={tw`mt-[6px]`} />
                ...
                >
                    <Ionicons name='pulse-outline' size={42} color={specificBodyparts.includes(3) ? 'white' : '#6b7280'} style={tw`mt-[6px]`} />
                ...
                >
                    <Ionicons name='accessibility-outline' size={42} color={specificBodyparts.includes(4) ? 'white' : '#6b7280'} style={tw`mt-[6px]`} />
                ...
                >
                    <Ionicons name='accessibility-outline' size={42} color={specificBodyparts.includes(5) ? 'white' : '#6b7280'} style={tw`mt-[6px]`} />
